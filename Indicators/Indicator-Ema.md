...
- [Indicator-Sma](/Indicators/Indicator-Sma) — equal weights, identical seed.
- [Indicator-Dema](/Indicators/Indicator-Dema) — `2·EMA − EMA(EMA)`.
- [Indicator-Tema](/Indicators/Indicator-Tema) — `3·EMA − 3·EMA(EMA) + EMA(EMA(EMA))`.
