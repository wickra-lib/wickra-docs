...
- [Indicator-FisherTransform](Indicator-FisherTransform) — the Fisher transform applied to price directly.
- [Indicator-InverseFisherTransform](Indicator-InverseFisherTransform) — the inverse mapping back into a bounded range.
