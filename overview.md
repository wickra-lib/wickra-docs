...
The project ships 219 indicators across sixteen families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.4.1   |
| crates.io | `wickra-core`  | 0.4.1   |
| crates.io | `wickra-data`  | 0.4.1   |
| PyPI      | `wickra`       | 0.4.1   |
| npm       | `wickra`       | 0.4.1   |
| npm       | `wickra-wasm`  | 0.4.1   |
