...
close — deeper than [OnNeck](/Indicators/Indicator-OnNeck) (to the low) but far short of a
...
2. **Mid of the neck family.** Slightly less bearish than [OnNeck](/Indicators/Indicator-OnNeck),
   more bearish than [Thrusting](/Indicators/Indicator-Thrusting).
...
- [OnNeck](/Indicators/Indicator-OnNeck) — bounce to the low.
