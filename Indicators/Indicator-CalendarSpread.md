...
negative when under (backwardation). Where [TermStructureBasis](/Indicators/Indicator-TermStructureBasis)
...
- **Reference is the perp, not spot.** Use [TermStructureBasis](/Indicators/Indicator-TermStructureBasis)
...
- [FundingBasis](/Indicators/Indicator-FundingBasis) — perpetual vs spot.
