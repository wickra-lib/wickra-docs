...
The project ships 359 indicators across twenty-one families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.5.1   |
| crates.io | `wickra-core`  | 0.5.1   |
| crates.io | `wickra-data`  | 0.5.1   |
| PyPI      | `wickra`       | 0.5.1   |
| npm       | `wickra`       | 0.5.1   |
| npm       | `wickra-wasm`  | 0.5.1   |
