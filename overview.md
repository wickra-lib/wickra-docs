...
The project ships 231 indicators across sixteen families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.4.2   |
| crates.io | `wickra-core`  | 0.4.2   |
| crates.io | `wickra-data`  | 0.4.2   |
| PyPI      | `wickra`       | 0.4.2   |
| npm       | `wickra`       | 0.4.2   |
| npm       | `wickra-wasm`  | 0.4.2   |
