...
[`Rsi`](Indicator-Rsi). A flat market (no gains and no losses) returns the
neutral `50`.
...
- [Indicator-Rsi](Indicator-Rsi) — the RMI at `momentum = 1`.
- [Indicator-ConnorsRsi](Indicator-ConnorsRsi) — another RSI extension.
