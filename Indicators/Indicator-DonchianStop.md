...
- [Donchian](/Indicators/Indicator-Donchian) — the entry-channel cousin.
- [HiLoActivator](/Indicators/Indicator-HiLoActivator) — SMA-based rather than
  min/max-based.
- [AtrTrailingStop](/Indicators/Indicator-AtrTrailingStop) — volatility-scaled
  alternative.
- [ChandelierExit](/Indicators/Indicator-ChandelierExit) — uses highest high
  with an ATR offset.
