...
- [Indicator-Ema](Indicator-Ema) — the consensus mean the powers are measured against.
- [Indicator-ElderImpulse](Indicator-ElderImpulse) — Elder's impulse system (EMA slope + MACD-hist).
