...
- **Zero-line crossings.** Use as a fast cycle-momentum signal.
  ...
  [Decycler](Indicator-Decycler)) to gate the direction.
...
- **Period mismatch with dominant cycle.** CG's zero-lag property
  ...
  [HilbertDominantCycle](Indicator-HilbertDominantCycle) to find
...
- [CyberneticCycle](Indicator-CyberneticCycle) — sibling
  near-zero-lag cycle component.
- [FisherTransform](Indicator-FisherTransform) — paired with CG
  in many Ehlers charts.
- [HilbertDominantCycle](Indicator-HilbertDominantCycle) — for
