...
SWMA from the linear [`Wma`](/Indicators/Indicator-Wma) (whose weights ramp monotonically to
the newest bar).
...
of the window, like an [`Sma`](/Indicators/Indicator-Sma), rather than near the front).
...
Prefer [`Ema`](/Indicators/Indicator-Ema) or [`Hma`](/Indicators/Indicator-Hma) when responsiveness
matters more than smoothness; prefer SWMA (or [`Sma`](/Indicators/Indicator-Sma)) when you
...
- [Indicator-Wma](/Indicators/Indicator-Wma) — linear (front-loaded) weights, the asymmetric counterpart.
- [Indicator-Sma](/Indicators/Indicator-Sma) — flat weights; the SWMA sits between SMA and WMA in smoothness.
- [Indicator-Alma](/Indicators/Indicator-Alma) — Gaussian-weighted window with an adjustable offset.
