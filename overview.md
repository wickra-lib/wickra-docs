...
The project ships 377 indicators across twenty-three families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.5.2   |
| crates.io | `wickra-core`  | 0.5.2   |
| crates.io | `wickra-data`  | 0.5.2   |
| PyPI      | `wickra`       | 0.5.2   |
| npm       | `wickra`       | 0.5.2   |
| npm       | `wickra-wasm`  | 0.5.2   |
