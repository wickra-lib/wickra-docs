...
instantaneous carry, and smooth it with [FundingRateMean](/Indicators/Indicator-FundingRateMean)
or normalise it with [FundingRateZScore](/Indicators/Indicator-FundingRateZScore) for a
regime view.
...
- [FundingRateMean](/Indicators/Indicator-FundingRateMean) — its rolling average.
- [FundingRateZScore](/Indicators/Indicator-FundingRateZScore) — its rolling z-score.
- [FundingBasis](/Indicators/Indicator-FundingBasis) — the spot basis funding chases.
