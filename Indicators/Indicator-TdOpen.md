...
- **Pair with trend filter.** Gap-fades work best in range-bound
  ...
  [EmpiricalModeDecomposition](/Indicators/Indicator-EmpiricalModeDecomposition)
...
- [TdDifferential](/Indicators/Indicator-TdDifferential) — 2-bar reversal
  pattern sibling.
- [TdRangeProjection](/Indicators/Indicator-TdRangeProjection) — next-bar
  range projection.
