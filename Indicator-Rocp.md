...
This is exactly [`Roc`](Indicator-Roc) divided by 100 — `Roc = 100 · ROCP`. The
...
Choose `Rocp` over [`Roc`](Indicator-Roc) when you want a fraction (0.05) rather
than a percentage (5.0); choose [`Rocr`](Indicator-Rocr) /
[`Rocr100`](Indicator-Rocr100) when you want the ratio form centred on `1` / `100`.
...
- [Indicator-Roc](Indicator-Roc) — the percentage form (`100 · ROCP`).
- [Indicator-Rocr](Indicator-Rocr) — the ratio form (`close / close[period]`).
- [Indicator-Rocr100](Indicator-Rocr100) — the ratio form ×100.
