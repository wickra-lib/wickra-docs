...
variants use [DragonflyDoji](Indicator-DragonflyDoji) /
[GravestoneDoji](Indicator-GravestoneDoji). See
...
- **Confusing with a rickshaw man.** [RickshawMan](Indicator-RickshawMan) adds
...
- [RickshawMan](Indicator-RickshawMan) — centred long-legged doji.
- [Doji](Indicator-Doji) — the general doji detector.
