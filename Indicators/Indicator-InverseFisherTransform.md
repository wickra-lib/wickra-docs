...
- [FisherTransform](/Indicators/Indicator-FisherTransform) — the algebraic
  inverse, applied to price.
- [Rsi](/Indicators/Indicator-Rsi) — most common IFT input.
- [LaguerreRsi](/Indicators/Indicator-LaguerreRsi) — bounded RSI variant that
  pairs well with IFT.
