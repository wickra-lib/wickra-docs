...
Use it alongside quote-based spreads ([QuotedSpread](Indicator-QuotedSpread),
[EffectiveSpread](Indicator-EffectiveSpread)) when only the tape is available, and
with [AmihudIlliquidity](Indicator-AmihudIlliquidity) for the price-impact side.
...
- [Indicator-QuotedSpread](Indicator-QuotedSpread) — quote-based spread.
- [Indicator-EffectiveSpread](Indicator-EffectiveSpread) — trade-vs-mid spread.
- [Indicator-AmihudIlliquidity](Indicator-AmihudIlliquidity) — price-impact liquidity.
