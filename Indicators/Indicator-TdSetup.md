...
- **Pairs with TdLines.** A completed setup defines TDST support
  / resistance (see [TdLines](/Indicators/Indicator-TdLines)) — break of that
...
- [TdSequential](/Indicators/Indicator-TdSequential) — pairs Setup with
  Countdown.
- [TdCountdown](/Indicators/Indicator-TdCountdown) — standalone Countdown.
