...
- [Cci](/Indicators/Indicator-Cci) — the typical-price oscillator WaveTrend generalises.
- [StochRsi](/Indicators/Indicator-StochRsi) — another bounded mean-reverting oscillator.
- [Smi](/Indicators/Indicator-Smi) — Blau's doubly-smoothed stochastic momentum.
