...
The Laguerre cascade is the same one [`LaguerreRsi`](Indicator-LaguerreRsi)
...
[`Ema`](Indicator-Ema): the adaptive filter will hug price more closely when
...
- [Indicator-LaguerreRsi](Indicator-LaguerreRsi) — the fixed-`gamma` Laguerre cascade in an RSI wrapper.
- [Indicator-Kama](Indicator-Kama) — Kaufman's adaptive moving average (efficiency-ratio damping).
- [Indicator-Frama](Indicator-Frama) — fractal-adaptive moving average.
