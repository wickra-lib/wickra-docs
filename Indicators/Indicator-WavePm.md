...
- [Indicator-Ema](/Indicators/Indicator-Ema) — the smoothing used for the energy and output.
- [Indicator-PolarizedFractalEfficiency](/Indicators/Indicator-PolarizedFractalEfficiency) — a complementary trend-efficiency gauge.
