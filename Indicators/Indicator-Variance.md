...
> of [StdDev](/Indicators/Indicator-StdDev). Natural input to risk calculations
...
units, use [StdDev](/Indicators/Indicator-StdDev) instead — it's just the
square root.
...
- [StdDev](/Indicators/Indicator-StdDev) — square-root sibling.
- [CoefficientOfVariation](/Indicators/Indicator-CoefficientOfVariation) —
  variance-normalised-by-mean.
- [MedianAbsoluteDeviation](/Indicators/Indicator-MedianAbsoluteDeviation) —
  robust alternative.
