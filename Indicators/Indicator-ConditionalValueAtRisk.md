...
> [ValueAtRisk](/Indicators/Indicator-ValueAtRisk) reports the loss *at* the
...
Same as [ValueAtRisk](/Indicators/Indicator-ValueAtRisk).
...
- [ValueAtRisk](/Indicators/Indicator-ValueAtRisk) — quantile boundary.
- [SortinoRatio](/Indicators/Indicator-SortinoRatio) — downside-deviation
  alternative.
- [MaxDrawdown](/Indicators/Indicator-MaxDrawdown) — drawdown-based loss
  measure.
