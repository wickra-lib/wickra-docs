...
shorter momentum horizon; the [`Wma`](/Indicators/Indicator-Wma) smooths
...
- [Indicator-Roc](/Indicators/Indicator-Roc) — the rate-of-change building block.
- [Indicator-Wma](/Indicators/Indicator-Wma) — the smoothing average.
