...
The project ships 474 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.6.6   |
| crates.io | `wickra-core`  | 0.6.6   |
| crates.io | `wickra-data`  | 0.6.6   |
| PyPI      | `wickra`       | 0.6.6   |
| npm       | `wickra`       | 0.6.6   |
| npm       | `wickra-wasm`  | 0.6.6   |
