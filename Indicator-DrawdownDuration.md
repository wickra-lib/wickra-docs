...
- [MaxDrawdown](Indicator-MaxDrawdown) — drawdown depth.
- [AverageDrawdown](Indicator-AverageDrawdown) — drawdown depth
  average.
- [UlcerIndex](Indicator-UlcerIndex) — depth × duration weighted.
