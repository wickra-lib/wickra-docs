...
- [Indicator-Sma](Indicator-Sma) — the moving average the index is measured against.
- [Indicator-PercentB](Indicator-PercentB) — analogous over-extension gauge within Bollinger bands.
