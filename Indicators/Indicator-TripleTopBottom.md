...
- [DoubleTopBottom](/Indicators/Indicator-DoubleTopBottom) — the two-extreme variant.
- [RectangleRange](/Indicators/Indicator-RectangleRange) — flat support/resistance range.
