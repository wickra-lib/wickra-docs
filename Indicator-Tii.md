...
Unlike [Adx](Indicator-Adx), TII is referenced to a moving average, so it
...
- [Adx](Indicator-Adx) — directional-strength complement (no MA reference).
- [VerticalHorizontalFilter](Indicator-VerticalHorizontalFilter) — range-based
  trend-strength filter.
- [ChoppinessIndex](Indicator-ChoppinessIndex) — trend-vs-range gauge.
