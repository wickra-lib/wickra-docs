...
- [Vidya](Indicator-Vidya) — momentum-gated adaptive MA.
- [Kama](Indicator-Kama) — efficiency-ratio-gated adaptive MA.
- [Ema](Indicator-Ema) — FRAMA's behaviour at `alpha → 1`.
- [HurstExponent](Indicator-HurstExponent) — the fractal/Hurst measure FRAMA
  implicitly uses.
