...
Unlike [RollingCorrelation](Indicator-RollingCorrelation) the result is **not**
...
[RollingCorrelation](Indicator-RollingCorrelation).
...
- [Indicator-RollingCorrelation](Indicator-RollingCorrelation) — the normalised version in `[−1, 1]`.
- [Indicator-Beta](Indicator-Beta) — `cov(a, b) / var(b)` on returns.
