...
The Gator Oscillator restates the [`Alligator`](Indicator-Alligator) as two
...
- **Display shift.** Wickra publishes the *unshifted* Alligator lines (see
  [`Indicator-Alligator`](Indicator-Alligator)); apply the classic forward shift
...
- [Indicator-Alligator](Indicator-Alligator) — the three SMMA lines the Gator measures the spread of.
