...
[`Vwap`](Indicator-Vwap) — VWAP weights by volume since the
...
- [Indicator-Sma](Indicator-Sma) — the equal-weighted counterpart.
- [Indicator-Vwap](Indicator-Vwap) — volume-weighted price
