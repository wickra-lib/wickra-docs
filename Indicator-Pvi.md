...
> Mirror of [Nvi](Indicator-Nvi): cumulative index that only
...
- [Nvi](Indicator-Nvi) — smart-money cousin.
- [Obv](Indicator-Obv) — simpler all-day cumulative volume.
- [Adl](Indicator-Adl) — alternative cumulative flow.
