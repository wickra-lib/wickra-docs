...
it alongside [WinRate](Indicator-WinRate) (hit rate) and the payoff side: a
...
- [Indicator-WinRate](Indicator-WinRate) — the hit-rate companion.
- [Indicator-KellyCriterion](Indicator-KellyCriterion) — edge-based bet sizing.
