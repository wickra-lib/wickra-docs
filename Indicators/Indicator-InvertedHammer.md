...
never `−1.0`. The same geometry read at the top of an uptrend is
the bearish [ShootingStar](/Indicators/Indicator-ShootingStar), which carries
the opposite sign.

## Inputs / Outputs

`Indicator<Input = Candle, Output = f64>`. Python / Node: same
shape as [Hammer](/Indicators/Indicator-Hammer).
...
- **Confusing with Shooting Star.** Same shape, opposite trend
  context. See [ShootingStar](/Indicators/Indicator-ShootingStar).
...
- [Hammer](/Indicators/Indicator-Hammer) — long lower shadow variant.
- [ShootingStar](/Indicators/Indicator-ShootingStar) — same shape, bearish
  reading.
- [HangingMan](/Indicators/Indicator-HangingMan) — Hammer's bearish twin.
