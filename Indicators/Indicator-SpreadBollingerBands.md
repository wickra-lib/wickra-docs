...
genuinely mean-reverting first with [SpreadHurst](/Indicators/Indicator-SpreadHurst) or
[VarianceRatio](/Indicators/Indicator-VarianceRatio) — bands on a trending spread give false
...
- [Indicator-SpreadHurst](/Indicators/Indicator-SpreadHurst) — confirm the spread mean-reverts.
- [Indicator-PairSpreadZScore](/Indicators/Indicator-PairSpreadZScore) — z-score timing on the spread.
