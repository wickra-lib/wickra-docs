...
The project ships 488 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.7.0   |
| crates.io | `wickra-core`  | 0.7.0   |
| crates.io | `wickra-data`  | 0.7.0   |
| PyPI      | `wickra`       | 0.7.0   |
| npm       | `wickra`       | 0.7.0   |
| npm       | `wickra-wasm`  | 0.7.0   |
