...
- [Indicator-Rsi](/Indicators/Indicator-Rsi) — the close-to-close analogue.
- [Indicator-BalanceOfPower](/Indicators/Indicator-BalanceOfPower) — another open/close pressure gauge.
