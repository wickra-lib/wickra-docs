...
[`ChandelierExit`](/Indicators/Indicator-ChandelierExit), it hangs off the close
...
- **Expecting it off the window high.** It trails the *close*, so it can sit
  closer to price than a [`ChandelierExit`](/Indicators/Indicator-ChandelierExit).
...
- [Indicator-ChandelierExit](/Indicators/Indicator-ChandelierExit) — an ATR stop hung
