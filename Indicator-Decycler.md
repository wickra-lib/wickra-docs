...
> [SuperSmoother](Indicator-SuperSmoother) for cycle/trend
> decomposition.
...
- **Pair with DecyclerOscillator.** Subtracting a fast Decycler
  ...
  [DecyclerOscillator](Indicator-DecyclerOscillator), an MACD-like
...
- [DecyclerOscillator](Indicator-DecyclerOscillator) — MACD-like
  oscillator built on the Decycler difference.
- [SuperSmoother](Indicator-SuperSmoother) — lowpass alternative.
- [RoofingFilter](Indicator-RoofingFilter) — bandpass dual.
