...
3. **Pair with the close end.** Combine with [ClosingMarubozu](Indicator-ClosingMarubozu)
   for end-of-bar control, or [Marubozu](Indicator-Marubozu) when both ends are
   shaved.
...
- [ClosingMarubozu](Indicator-ClosingMarubozu) — the close end shaved instead.
- [BeltHold](Indicator-BeltHold) — a related open-at-the-extreme bar.
