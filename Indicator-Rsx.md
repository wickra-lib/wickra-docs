...
lag-cancelling structure as a [`Dema`](Indicator-Dema). Running both the signed
...
- [Indicator-Rsi](Indicator-Rsi) — the oscillator RSX smooths.
- [Indicator-Jma](Indicator-Jma) — Jurik-style smoothing applied to price.
- [Indicator-ConnorsRsi](Indicator-ConnorsRsi) — another RSI refinement.
