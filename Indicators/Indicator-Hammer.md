...
bearish [HangingMan](/Indicators/Indicator-HangingMan), which carries the
opposite sign.
...
- **Pair with confirmation.** Many traders require the next bar
  ...
  [ThreeOutside](/Indicators/Indicator-ThreeOutside) for the confirmed
...
- **Confusing with Hanging Man.** Same shape, opposite trend
  ...
  [HangingMan](/Indicators/Indicator-HangingMan).
...
- [HangingMan](/Indicators/Indicator-HangingMan) — same shape, bearish
  context.
- [InvertedHammer](/Indicators/Indicator-InvertedHammer) — mirror with long
  upper shadow.
- [ShootingStar](/Indicators/Indicator-ShootingStar) — Inverted Hammer's
  bearish twin.
