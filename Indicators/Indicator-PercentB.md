...
[`BollingerBands`](/Indicators/Indicator-BollingerBands). `%b = 1` is price exactly
...
- **Confusing it with bandwidth.** %b is price *position*;
  [`BollingerBandwidth`](/Indicators/Indicator-BollingerBandwidth) is band *width*.
...
- [Indicator-BollingerBands](/Indicators/Indicator-BollingerBands) — the bands
  this locates price within.
- [Indicator-BollingerBandwidth](/Indicators/Indicator-BollingerBandwidth) — the
