...
`12, 26, 9` to recover [`MacdFix`](Indicator-MacdFix) / the standard MACD.
...
- [Indicator-MacdIndicator](Indicator-MacdIndicator) — the fully configurable EMA MACD.
- [Indicator-MacdFix](Indicator-MacdFix) — the fixed 12/26 MACD.
