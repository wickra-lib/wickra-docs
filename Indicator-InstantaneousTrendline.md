...
- [Decycler](Indicator-Decycler) — slower trend extractor.
- [SuperSmoother](Indicator-SuperSmoother) — pure 2-pole lowpass.
- [Mama](Indicator-Mama) — adaptive sibling.
- [SineWave](Indicator-SineWave) — cycle-state companion.
