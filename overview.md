...
The project ships 413 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.5.6   |
| crates.io | `wickra-core`  | 0.5.6   |
| crates.io | `wickra-data`  | 0.5.6   |
| PyPI      | `wickra`       | 0.5.6   |
| npm       | `wickra`       | 0.5.6   |
| npm       | `wickra-wasm`  | 0.5.6   |
