...
PPO is [`MacdIndicator`](/Indicators/Indicator-MacdIndicator) divided by the slow
...
- [Indicator-MacdIndicator](/Indicators/Indicator-MacdIndicator) — the price-unit
  original, with a bundled signal line and histogram.
- [Indicator-Ema](/Indicators/Indicator-Ema) — the underlying average.
