...
- [Indicator-Wma](Indicator-Wma) — the building block.
- [Indicator-Tema](Indicator-Tema) — same lag-reduction goal, EMA-based.
- [Indicator-Kama](Indicator-Kama) — adaptive smoothing instead of fixed.
