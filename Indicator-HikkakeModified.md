...
> Close-confirmed variant of the [Hikkake](Indicator-Hikkake) trap. An
...
[Hikkake](Indicator-Hikkake), which fires on the high/low break alone. See
...
- **Confusing with plain hikkake.** [Hikkake](Indicator-Hikkake) needs only the
...
- [Hikkake](Indicator-Hikkake) — the plain break-only variant.
