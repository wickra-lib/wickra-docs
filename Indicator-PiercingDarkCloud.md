...
- **Partial-engulfing.** Closes inside but past the midpoint of
  ...
  a stronger pattern — see [Engulfing](Indicator-Engulfing).
...
- [Engulfing](Indicator-Engulfing) — stronger sibling reversal
  pattern.
- [Harami](Indicator-Harami) — softer reversal cousin.
