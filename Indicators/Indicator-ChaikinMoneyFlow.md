...
CMF is the [`Adl`](/Indicators/Indicator-Adl) increment averaged the way RSI averages
...
[`Adl`](/Indicators/Indicator-Adl), whose level is arbitrary.
...
- [Indicator-Adl](/Indicators/Indicator-Adl) — the cumulative line CMF is built on.
- [Indicator-ChaikinOscillator](/Indicators/Indicator-ChaikinOscillator) — the
