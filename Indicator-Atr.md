...
- [Bollinger Bands](Indicator-BollingerBands) — stddev-based volatility
  envelope around an SMA.
- [Keltner Channels](Indicator-Keltner) — directly composes EMA + ATR.
- [Donchian Channels](Indicator-Donchian) — rolling high/low without
  any smoothing.
- [PSAR](Indicator-Psar) — uses ATR-like volatility tracking implicitly
