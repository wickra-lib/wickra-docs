...
[RegimeLabel](Indicator-RegimeLabel)); robust band edges ignore the tails. The
...
- [Indicator-RollingIqr](Indicator-RollingIqr) — `Q3 − Q1` built on the same quantiles.
- [Indicator-MedianAbsoluteDeviation](Indicator-MedianAbsoluteDeviation) — robust dispersion.
