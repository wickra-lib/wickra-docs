...
- **Pearson on monotone series.** Returns can be near ±1 even
  ...
  [SpearmanCorrelation](/Indicators/Indicator-SpearmanCorrelation).
...
- [SpearmanCorrelation](/Indicators/Indicator-SpearmanCorrelation) — rank-
  based cousin (handles monotone nonlinearities).
- [Beta](/Indicators/Indicator-Beta) — slope rather than correlation.
- [Autocorrelation](/Indicators/Indicator-Autocorrelation) — single-series
  cousin.
