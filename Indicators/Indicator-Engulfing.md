...
- **Doji as prior bar.** `prev_body == 0` means `curr_body > 0`
  ...
  [MorningEveningStar](/Indicators/Indicator-MorningEveningStar) for that
  pattern.
...
- **Pair with confirmation.** [ThreeOutside](/Indicators/Indicator-ThreeOutside)
...
- [Harami](/Indicators/Indicator-Harami) — opposite pattern (small inside
  large body).
- [ThreeOutside](/Indicators/Indicator-ThreeOutside) — confirmed three-bar
  Engulfing variant.
- [PiercingDarkCloud](/Indicators/Indicator-PiercingDarkCloud) — softer
