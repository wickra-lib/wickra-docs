...
The project ships 440 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.6.1   |
| crates.io | `wickra-core`  | 0.6.1   |
| crates.io | `wickra-data`  | 0.6.1   |
| PyPI      | `wickra`       | 0.6.1   |
| npm       | `wickra`       | 0.6.1   |
| npm       | `wickra-wasm`  | 0.6.1   |
