...
[`ChandelierExit`](Indicator-ChandelierExit). The second smooths it: rather
...
Compared with a one-stage [`ChandelierExit`](Indicator-ChandelierExit), the
...
- [Indicator-ChandelierExit](Indicator-ChandelierExit) — the one-stage
