...
- [Indicator-SuperTrend](Indicator-SuperTrend) — another trend on/off filter, ATR-banded.
- [Indicator-TrendLabel](Indicator-TrendLabel) — a regime label from a different construction.
