...
cousin of [ZScore](Indicator-ZScore): no Gaussian assumption, just rank.
...
- [Indicator-ZScore](Indicator-ZScore) — the parametric analogue.
- [Indicator-RollingQuantile](Indicator-RollingQuantile) — the inverse mapping (rank → value).
