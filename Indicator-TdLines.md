...
- [TdSetup](Indicator-TdSetup) — the setup phase TDST is derived
  from.
- [TdSequential](Indicator-TdSequential) — TDST is used as
  invalidation for completed Sequentials.
- [TdRiskLevel](Indicator-TdRiskLevel) — alternative stop
  formulation.
