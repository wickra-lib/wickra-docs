...
[Marubozu](Indicator-Marubozu). Thresholds are geometric (fixed fractions of
...
3. **Pair with the open end.** Combine with [OpeningMarubozu](Indicator-OpeningMarubozu)
   or full [Marubozu](Indicator-Marubozu) to grade how complete the
...
- [Marubozu](Indicator-Marubozu) — both ends shaved.
- [OpeningMarubozu](Indicator-OpeningMarubozu) — the open end shaved instead.
- [BeltHold](Indicator-BeltHold) — opens at the extreme and runs the other way.
