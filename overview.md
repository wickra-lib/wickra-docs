...
The project ships 423 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.5.8   |
| crates.io | `wickra-core`  | 0.5.8   |
| crates.io | `wickra-data`  | 0.5.8   |
| PyPI      | `wickra`       | 0.5.8   |
| npm       | `wickra`       | 0.5.8   |
| npm       | `wickra-wasm`  | 0.5.8   |
