...
The natural-log analogue of [Roc](Indicator-Roc) (which reports the simple
...
[Roc](Indicator-Roc); for the realised volatility built on these returns see
[RealizedVolatility](Indicator-RealizedVolatility) and
...
- **Confusing it with simple return.** `LogReturn` is `ln(p_t / p_{t−k})`, not
  ...
  for large ones. Use [Roc](Indicator-Roc) if you specifically want the simple
  percentage.
...
- [Indicator-Roc](Indicator-Roc) — the simple-percentage analogue.
- [Indicator-RealizedVolatility](Indicator-RealizedVolatility) — built on these returns.
