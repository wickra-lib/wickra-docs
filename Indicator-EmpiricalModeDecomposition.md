...
- **Pair with cycle oscillators.** EMD acts as a *trend filter*;
  pair it with [CenterOfGravity](Indicator-CenterOfGravity) or
...
- [RoofingFilter](Indicator-RoofingFilter) — alternative
  band-isolation tool.
- [SuperSmoother](Indicator-SuperSmoother) — building block for
  the envelope smoothers.
- [DecyclerOscillator](Indicator-DecyclerOscillator) — different
