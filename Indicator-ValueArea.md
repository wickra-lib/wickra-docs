...
- [InitialBalance](Indicator-InitialBalance) — first-bars range.
- [OpeningRange](Indicator-OpeningRange) — opening-range
  breakout reference.
- [Vwap](Indicator-Vwap) — closely-related volume-weighted
  price.
