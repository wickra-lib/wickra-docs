...
> [RoofingFilter](Indicator-RoofingFilter) (high-pass + SuperSmoother
...
- [RoofingFilter](Indicator-RoofingFilter) — the underlying
  pre-filter.
- [Stochastic](Indicator-Stochastic) — classical Stochastic on
  raw price.
- [SuperSmoother](Indicator-SuperSmoother) — final smoothing
  stage.
