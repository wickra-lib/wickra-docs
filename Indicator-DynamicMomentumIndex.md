...
- [Indicator-Rsi](Indicator-Rsi) — the fixed-period baseline.
- [Indicator-Rmi](Indicator-Rmi) — RSI over a multi-bar momentum window.
- [Indicator-Kama](Indicator-Kama) — another volatility-adaptive construction.
