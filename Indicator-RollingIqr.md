...
identical to [RollingQuantile](Indicator-RollingQuantile). The IQR is the spread
...
- [Indicator-RollingQuantile](Indicator-RollingQuantile) — the quartiles this differences.
- [Indicator-StdDev](Indicator-StdDev) — non-robust dispersion.
