...
[MacdIndicator](/Indicators/Indicator-MacdIndicator) and emits only the `histogram`
...
when [MacdIndicator](/Indicators/Indicator-MacdIndicator) emits its first full output.
...
- **Equals the MACD histogram field.** The standalone series is bit-for-bit
  the `histogram` field of [MacdIndicator](/Indicators/Indicator-MacdIndicator) over the
...
[MacdIndicator](/Indicators/Indicator-MacdIndicator) directly. For a scale-free version
comparable across instruments, see [PpoHistogram](/Indicators/Indicator-PpoHistogram).
...
- **Reading absolute height across symbols.** The histogram is in price
  ...
  use [PpoHistogram](/Indicators/Indicator-PpoHistogram) for that.
...
- [MacdIndicator](/Indicators/Indicator-MacdIndicator) — the full MACD line, signal and
  histogram.
- [PpoHistogram](/Indicators/Indicator-PpoHistogram) — the scale-free, percentage
  counterpart.
- [AwesomeOscillatorHistogram](/Indicators/Indicator-AwesomeOscillatorHistogram) — a
