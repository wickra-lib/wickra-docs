...
a same-period [`Sma`](/Indicators/Indicator-Sma) noticeably less. This is
TA-Lib's `LINEARREG`.
...
[`LinRegSlope`](/Indicators/Indicator-LinRegSlope) and
[`LinRegAngle`](/Indicators/Indicator-LinRegAngle).
...
[`LinRegSlope`](/Indicators/Indicator-LinRegSlope) to read the same fit's steepness.
...
- [Indicator-LinRegSlope](/Indicators/Indicator-LinRegSlope) — the slope of the same
  rolling fit.
- [Indicator-Sma](/Indicators/Indicator-Sma) — the centred average it is
