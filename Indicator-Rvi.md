...
> [RVIVolatility](Indicator-RviVolatility).
...
2. **Signal-line use.** Dorsey's full system applies a 4-bar weighted
   ...
   [Sma](Indicator-Sma)/[Ema](Indicator-Ema).

## Common pitfalls

- **Confusing it with the Relative Volatility Index.** Different indicator,
  shared abbreviation — see [RVIVolatility](Indicator-RviVolatility).
...
- [Inertia](Indicator-Inertia) — a linear-regression smoothing of RVI.
- [RVIVolatility](Indicator-RviVolatility) — the unrelated volatility RVI.
- [Stochastic](Indicator-Stochastic) — another close-position oscillator.
