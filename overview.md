...
The project ships 479 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.6.7   |
| crates.io | `wickra-core`  | 0.6.7   |
| crates.io | `wickra-data`  | 0.6.7   |
| PyPI      | `wickra`       | 0.6.7   |
| npm       | `wickra`       | 0.6.7   |
| npm       | `wickra-wasm`  | 0.6.7   |
