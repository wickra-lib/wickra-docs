...
> [InvertedHammer](/Indicators/Indicator-InvertedHammer) — small body near the
...
is the bullish [InvertedHammer](/Indicators/Indicator-InvertedHammer), which
...
- [InvertedHammer](/Indicators/Indicator-InvertedHammer) — same shape,
  bullish reading.
- [HangingMan](/Indicators/Indicator-HangingMan) — bearish, with long lower
  shadow.
