...
[Smma](/Indicators/Indicator-Smma) is Wilder's smoothed moving average (RMA), SMA-seeded
...
([FractalChaosBands](/Indicators/Indicator-FractalChaosBands)): a fractal breakout
...
- [Smma](/Indicators/Indicator-Smma) — the smoothed moving average each line uses.
- [FractalChaosBands](/Indicators/Indicator-FractalChaosBands) — Williams' fractals,
  the Alligator's usual partner.
- [AwesomeOscillator](/Indicators/Indicator-AwesomeOscillator) — Williams' momentum gauge.
