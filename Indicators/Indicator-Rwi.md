...
- [Adx](/Indicators/Indicator-Adx) — smoothed trend-strength gauge.
- [Adxr](/Indicators/Indicator-Adxr) — averaged ADX.
- [ChoppinessIndex](/Indicators/Indicator-ChoppinessIndex) — log-scaled trend-vs-range
  complement.
