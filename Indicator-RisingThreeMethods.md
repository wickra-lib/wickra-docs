...
[FallingThreeMethods](Indicator-FallingThreeMethods). The three resting bars
stay *inside* bar1's range (unlike [MatHold](Indicator-MatHold), where they gap
...
2. **Range-contained vs gapped.** Where the rest gaps up and holds rather than
   drifting inside, see [MatHold](Indicator-MatHold).
...
- [FallingThreeMethods](Indicator-FallingThreeMethods) — the bearish mirror.
- [MatHold](Indicator-MatHold) — the gap-and-hold variant.
