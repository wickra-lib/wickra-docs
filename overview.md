...
The project ships 339 indicators across twenty families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.4.7   |
| crates.io | `wickra-core`  | 0.4.7   |
| crates.io | `wickra-data`  | 0.4.7   |
| PyPI      | `wickra`       | 0.4.7   |
| npm       | `wickra`       | 0.4.7   |
| npm       | `wickra-wasm`  | 0.4.7   |
