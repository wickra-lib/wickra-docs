...
> [HilbertDominantCycle](Indicator-HilbertDominantCycle) to derive
...
- [HilbertDominantCycle](Indicator-HilbertDominantCycle) — phase
  source.
- [Mama](Indicator-Mama) — uses the same phase for adaptive
  smoothing.
- [FisherTransform](Indicator-FisherTransform) — different
