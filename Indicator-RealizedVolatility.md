...
Unlike [HistoricalVolatility](Indicator-HistoricalVolatility) — which reports the
...
risk, use [HistoricalVolatility](Indicator-HistoricalVolatility) instead.
...
- [Indicator-HistoricalVolatility](Indicator-HistoricalVolatility) — annualised sample-stddev volatility.
- [Indicator-LogReturn](Indicator-LogReturn) — the returns summed here.
