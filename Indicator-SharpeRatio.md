...
- [SortinoRatio](Indicator-SortinoRatio) — downside-only
  volatility variant.
- [CalmarRatio](Indicator-CalmarRatio) — return-over-max-drawdown
  alternative.
- [InformationRatio](Indicator-InformationRatio) —
  benchmark-relative Sharpe.
- [TreynorRatio](Indicator-TreynorRatio) — beta-relative Sharpe.
