...
- [TakerBuySellRatio](/Indicators/Indicator-TakerBuySellRatio) — aggressive flow that often
  accompanies cascades.
- [OpenInterestDelta](/Indicators/Indicator-OpenInterestDelta) — positioning unwind.
