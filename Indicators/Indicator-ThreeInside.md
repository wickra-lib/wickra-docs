...
- [Harami](/Indicators/Indicator-Harami) — unconfirmed two-bar version.
- [ThreeOutside](/Indicators/Indicator-ThreeOutside) — sibling three-bar
  pattern.
- [MorningEveningStar](/Indicators/Indicator-MorningEveningStar) — another
  three-bar reversal.
