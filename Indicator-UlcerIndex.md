...
- **Reading it as two-sided volatility.** The Ulcer Index ignores upside
  ...
  [`StdDev`](Indicator-StdDev) for two-sided dispersion.
...
- [Indicator-StdDev](Indicator-StdDev) — two-sided dispersion.
- [Indicator-Atr](Indicator-Atr) — per-bar range volatility.
