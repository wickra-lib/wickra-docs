...
the midpoint of the corresponding [Donchian](/Indicators/Indicator-Donchian)
...
Prefer the Hurst Channel over [BollingerBands](/Indicators/Indicator-BollingerBands)
...
- **Confusing the channel with the [HurstExponent](/Indicators/Indicator-HurstExponent).**
...
- [Donchian](/Indicators/Indicator-Donchian) — pure rolling high/low (no midline offset).
- [BollingerBands](/Indicators/Indicator-BollingerBands) — sigma-based dispersion.
- [Keltner](/Indicators/Indicator-Keltner) — ATR-based dispersion.
- [MaEnvelope](/Indicators/Indicator-MaEnvelope) — fixed-percent band around an SMA.
