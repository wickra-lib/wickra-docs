...
previous close and falls back to `high − low`. Where [`Atr`](Indicator-Atr)
...
[`Atr`](Indicator-Atr); using it directly is useful for volatility-scaled
...
- [Indicator-Atr](Indicator-Atr) — the Wilder-smoothed average of the
  True Range.
- [Indicator-ChaikinVolatility](Indicator-ChaikinVolatility) — a
