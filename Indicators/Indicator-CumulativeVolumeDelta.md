...
- [SignedVolume](/Indicators/Indicator-SignedVolume) — the per-trade increment CVD sums.
- [TradeImbalance](/Indicators/Indicator-TradeImbalance) — the bounded, windowed cousin.
- [Footprint](/Indicators/Indicator-Footprint) — the same flow resolved by price level.
