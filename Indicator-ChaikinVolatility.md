...
move. It complements [`Atr`](Indicator-Atr): ATR gives the level of
...
- [Indicator-Atr](Indicator-Atr) — the level of per-bar volatility.
- [Indicator-TrueRange](Indicator-TrueRange) — raw single-bar range.
