...
the window. Where [`LinearRegression`](Indicator-LinearRegression) evaluates the
...
Together with [`LinRegSlope`](Indicator-LinRegSlope) it fully describes the
...
Prefer [`LinearRegression`](Indicator-LinearRegression) when you want the fitted
value at the current bar, and [`Tsf`](Indicator-Tsf) when you want it projected
one bar ahead.
...
- [Indicator-LinRegSlope](Indicator-LinRegSlope) — the slope `b`.
- [Indicator-Tsf](Indicator-Tsf) — the fit projected one bar ahead.
