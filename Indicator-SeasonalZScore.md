...
- [TurnOfMonth](Indicator-TurnOfMonth) — monthly calendar anomaly.
- [TimeOfDayReturnProfile](Indicator-TimeOfDayReturnProfile) — raw hourly means.
- [ZScore](Indicator-ZScore) — rolling (non-seasonal) z-score.
