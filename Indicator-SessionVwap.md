...
- [RollingVwap](Indicator-RollingVwap) — fixed-window VWAP, no session anchor.
- [AnchoredVwap](Indicator-AnchoredVwap) — anchors at a caller-chosen bar.
- [SessionHighLow](Indicator-SessionHighLow) — companion session range.
