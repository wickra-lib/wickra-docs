...
[`HilbertDominantCycle`](Indicator-HilbertDominantCycle) — a 4-bar weighted
...
of [`HtDcPhase`](Indicator-HtDcPhase) and [`HtTrendMode`](Indicator-HtTrendMode)),
its rate of change gives the dominant cycle period
([`HilbertDominantCycle`](Indicator-HilbertDominantCycle)), and the magnitude
...
- [Indicator-HtDcPhase](Indicator-HtDcPhase) — the dominant-cycle phase derived from this pair.
- [Indicator-HtTrendMode](Indicator-HtTrendMode) — trend/cycle classification.
- [Indicator-HilbertDominantCycle](Indicator-HilbertDominantCycle) — the cycle period.
