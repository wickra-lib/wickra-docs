...
- [VolumeProfile](Indicator-VolumeProfile) — volume by *price*, not time.
- [TimeOfDayReturnProfile](Indicator-TimeOfDayReturnProfile) — return by time.
- [Vwap](Indicator-Vwap) — volume-weighted average price.
