...
Bearish-only (never `+1.0`). Unlike [TwoCrows](Indicator-TwoCrows), the second
...
3. **Compare with Two Crows.** [TwoCrows](Indicator-TwoCrows) fills the gap;
...
- [TwoCrows](Indicator-TwoCrows) — the gap-filling sibling.
- [PiercingDarkCloud](Indicator-PiercingDarkCloud) — two-bar top reversal.
