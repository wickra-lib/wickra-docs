...
[`Rsi`](/Indicators/Indicator-Rsi) and [`Atr`](/Indicators/Indicator-Atr),
...
- [Indicator-Ema](/Indicators/Indicator-Ema) — faster exponential average.
- [Indicator-Sma](/Indicators/Indicator-Sma) — the equal-weighted mean used as
  the SMMA seed.
- [Indicator-Trima](/Indicators/Indicator-Trima) — the other F1 average.
