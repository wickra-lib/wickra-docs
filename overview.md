...
The project ships 462 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.6.4   |
| crates.io | `wickra-core`  | 0.6.4   |
| crates.io | `wickra-data`  | 0.6.4   |
| PyPI      | `wickra`       | 0.6.4   |
| npm       | `wickra`       | 0.6.4   |
| npm       | `wickra-wasm`  | 0.6.4   |
