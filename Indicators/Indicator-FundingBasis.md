...
instantaneous basis alongside [FundingRate](/Indicators/Indicator-FundingRate) separates a
...
- **Perp vs dated future.** This is the *perpetual*'s basis. For a dated
  future's basis use [TermStructureBasis](/Indicators/Indicator-TermStructureBasis).

## See also

- [TermStructureBasis](/Indicators/Indicator-TermStructureBasis) — dated future vs spot.
- [CalendarSpread](/Indicators/Indicator-CalendarSpread) — dated future vs perpetual.
- [FundingRate](/Indicators/Indicator-FundingRate) — the rate the basis drives.
