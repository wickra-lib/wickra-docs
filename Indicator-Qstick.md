...
- [Indicator-Sma](Indicator-Sma) — the averaging core Qstick runs on the body.
- [Indicator-IntradayMomentumIndex](Indicator-IntradayMomentumIndex) — another body-based sentiment gauge, bounded `[0, 100]`.
