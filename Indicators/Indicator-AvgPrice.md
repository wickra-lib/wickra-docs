...
Where [`TypicalPrice`](/Indicators/Indicator-TypicalPrice) is `(H + L + C) / 3` and
[`WeightedClose`](/Indicators/Indicator-WeightedClose) is `(H + L + 2C) / 4`, `AvgPrice` is
...
geometric centre than [`TypicalPrice`](/Indicators/Indicator-TypicalPrice) on bars with a
...
Prefer [`TypicalPrice`](/Indicators/Indicator-TypicalPrice) when you specifically want the
`(H + L + C) / 3` series that [`Cci`](/Indicators/Indicator-Cci) and [`Mfi`](/Indicators/Indicator-Mfi)
are defined on; prefer [`MedianPrice`](/Indicators/Indicator-MedianPrice) when you only care
...
- [Indicator-TypicalPrice](/Indicators/Indicator-TypicalPrice) — `(H + L + C) / 3`.
- [Indicator-WeightedClose](/Indicators/Indicator-WeightedClose) — `(H + L + 2C) / 4`.
- [Indicator-MedianPrice](/Indicators/Indicator-MedianPrice) — `(H + L) / 2`.
