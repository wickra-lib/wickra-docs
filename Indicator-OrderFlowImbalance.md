...
toxicity ([Vpin](Indicator-Vpin)) and the static book imbalance
...
- [Indicator-OrderBookImbalanceTop1](Indicator-OrderBookImbalanceTop1) — static best-level imbalance.
- [Indicator-Vpin](Indicator-Vpin) — trade-flow toxicity.
