...
This is [`Rocp`](Indicator-Rocp) plus one (`ROCR = 1 + ROCP`): the ratio form
...
Choose `Rocr` over [`Rocp`](Indicator-Rocp) when you want a ratio centred on `1`;
choose [`Rocr100`](Indicator-Rocr100) when you prefer the same ratio rescaled so
...
- [Indicator-Rocp](Indicator-Rocp) — the fractional form (`ROCR − 1`).
- [Indicator-Rocr100](Indicator-Rocr100) — the same ratio ×100.
- [Indicator-Roc](Indicator-Roc) — the percentage form.
