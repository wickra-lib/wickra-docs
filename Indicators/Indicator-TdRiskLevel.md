...
- **Less aggressive than TDST.** Compared to
  [TdLines](/Indicators/Indicator-TdLines)' TDST levels (which mark
...
- [TdSetup](/Indicators/Indicator-TdSetup) — the setup phase Risk Level is
  derived from.
- [TdSequential](/Indicators/Indicator-TdSequential) — pairs with Risk Level
  for completed entries.
- [TdLines](/Indicators/Indicator-TdLines) — alternative invalidation level
  (TDST).
- [Atr](/Indicators/Indicator-Atr) — the volatility unit used in the
  true-range buffer.
