...
- **Spoofable.** A single best-level size can be posted and pulled in
  ...
  [Full](/Indicators/Indicator-OrderBookImbalanceFull)) or executed flow
...
- **Ignores price, only size.** It says nothing about *where* the quotes sit,
  only their relative size — pair with [QuotedSpread](/Indicators/Indicator-QuotedSpread)
...
- [OrderBookImbalanceTopN](/Indicators/Indicator-OrderBookImbalanceTopN) — the same idea
  aggregated over the near book, more robust to spoofing.
- [OrderBookImbalanceFull](/Indicators/Indicator-OrderBookImbalanceFull) — whole-book
  pressure for slower bias.
- [Microprice](/Indicators/Indicator-Microprice) — turns this imbalance into a fair value.
