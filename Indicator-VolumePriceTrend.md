...
VPT is a close relative of [`Obv`](Indicator-Obv). Where OBV adds the
...
- [Indicator-Obv](Indicator-Obv) — cumulative signed volume, the
  closest relative.
- [Indicator-Adl](Indicator-Adl) — cumulative range-weighted volume.
