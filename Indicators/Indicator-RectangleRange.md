...
- [Triangle](/Indicators/Indicator-Triangle) — converging (non-parallel) range.
- [TripleTopBottom](/Indicators/Indicator-TripleTopBottom) — three rejections at one level.
