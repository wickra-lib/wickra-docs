...
- [Keltner Channels](Indicator-Keltner) — same envelope shape but band
  width is driven by ATR instead of stddev.
- [Donchian Channels](Indicator-Donchian) — rolling high/low envelope
  with no smoothing.
- [ATR](Indicator-Atr) — the volatility scale most commonly used to
