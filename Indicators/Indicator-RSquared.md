...
- **Direction-blind.** R² doesn't tell you trend direction;
  pair with slope sign ([LinRegSlope](/Indicators/Indicator-LinRegSlope))
  for full picture.
...
- [LinearRegression](/Indicators/Indicator-LinearRegression) — the fitted
  line itself.
- [LinRegSlope](/Indicators/Indicator-LinRegSlope) — slope of the line.
- [LinRegAngle](/Indicators/Indicator-LinRegAngle) — slope as an angle.
- [StandardError](/Indicators/Indicator-StandardError) — residual measure.
