...
Where [FundingBasis](/Indicators/Indicator-FundingBasis) measures the *perpetual*'s premium
...
- **Future vs perp.** This uses the dated `futures_price`. For the perpetual's
  basis use [FundingBasis](/Indicators/Indicator-FundingBasis); for future-vs-perp use
