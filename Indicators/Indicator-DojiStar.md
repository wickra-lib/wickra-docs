...
2. **Wait for confirmation.** [MorningDojiStar](/Indicators/Indicator-MorningDojiStar) /
   [EveningDojiStar](/Indicators/Indicator-EveningDojiStar) add the third bar that confirms
...
- [MorningDojiStar](/Indicators/Indicator-MorningDojiStar) /
  [EveningDojiStar](/Indicators/Indicator-EveningDojiStar) — confirmed three-bar stars.
- [AbandonedBaby](/Indicators/Indicator-AbandonedBaby) — the full-gap island version.
