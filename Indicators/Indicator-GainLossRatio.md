...
> of [ProfitFactor](/Indicators/Indicator-ProfitFactor) which sums rather than
> averages.
...
- [ProfitFactor](/Indicators/Indicator-ProfitFactor) — sum-based cousin.
- [KellyCriterion](/Indicators/Indicator-KellyCriterion) — uses GLR
  components for sizing.
- [OmegaRatio](/Indicators/Indicator-OmegaRatio) — threshold-aware variant.
