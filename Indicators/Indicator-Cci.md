...
- [Indicator: Rsi](/Indicators/Indicator-Rsi) — bounded sibling for comparison.
- [Indicator: WilliamsR](/Indicators/Indicator-WilliamsR) — another candle-input
  oscillator, range-based rather than deviation-based.
- [Indicator: Mfi](/Indicators/Indicator-Mfi) — volume-weighted RSI; useful as a
