...
2. **Mirror of retracement.** [FibRetracement](/Indicators/Indicator-FibRetracement) maps the
...
- **Two-point, not measured-move.** This projects a *single* leg. For an A-B-C
  measured move use [FibProjection](/Indicators/Indicator-FibProjection).
...
- [FibRetracement](/Indicators/Indicator-FibRetracement), [FibProjection](/Indicators/Indicator-FibProjection),
