...
- [TdRei](Indicator-TdRei) — non-volume-weighted DeMark momentum
  oscillator.
- [TdDeMarker](Indicator-TdDeMarker) — high/low-based DeMark
  oscillator.
- [Obv](Indicator-Obv) — cumulative volume-direction indicator.
- [Mfi](Indicator-Mfi) — money-flow alternative oscillator.
