...
- **Resting vs. executed.** Unlike [KylesLambda](/Indicators/Indicator-KylesLambda), which
...
- **Posted, not committed.** It measures the *resting* book, which can be
  ...
  [TradeImbalance](/Indicators/Indicator-TradeImbalance) before trusting it.
...
- [OrderBookImbalanceFull](/Indicators/Indicator-OrderBookImbalanceFull) — net depth
  pressure, the *imbalance* of the book rather than its slope.
- [Microprice](/Indicators/Indicator-Microprice) — fair value from top-of-book sizes.
- [KylesLambda](/Indicators/Indicator-KylesLambda) — realised impact from executed flow.
