...
- [MaxDrawdown](Indicator-MaxDrawdown) — denominator alone.
- [SharpeRatio](Indicator-SharpeRatio) — volatility-based
  alternative.
- [SortinoRatio](Indicator-SortinoRatio) — downside-volatility
  alternative.
- [RecoveryFactor](Indicator-RecoveryFactor) — cumulative cousin.
