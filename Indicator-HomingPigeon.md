...
- **Expecting a colour flip.** Unlike a bullish [Harami](Indicator-Harami), the
...
- [Harami](Indicator-Harami) — the colour-flip inside-bar reversal.
- [MatchingLow](Indicator-MatchingLow) — another soft two-bar bottoming pattern.
