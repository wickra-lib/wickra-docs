...
only arm [PairSpreadZScore](/Indicators/Indicator-PairSpreadZScore) or
[SpreadBollingerBands](/Indicators/Indicator-SpreadBollingerBands) when `H` confirms
anti-persistence, and size the holding period with
[OuHalfLife](/Indicators/Indicator-OuHalfLife).
...
- [Indicator-OuHalfLife](/Indicators/Indicator-OuHalfLife) — reversion time scale once `H < 0.5`.
- [Indicator-VarianceRatio](/Indicators/Indicator-VarianceRatio) — a complementary mean-reversion test.
