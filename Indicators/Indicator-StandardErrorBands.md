...
> slightly wider than [LinRegChannel](/Indicators/Indicator-LinRegChannel).
...
used by [LinRegChannel](/Indicators/Indicator-LinRegChannel) — exactly by a factor
...
own smoother (e.g. [`Sma::new(3)`](/Indicators/Indicator-Sma)).
...
use mirrors [LinRegChannel](/Indicators/Indicator-LinRegChannel):
...
- **Comparing band width to [LinRegChannel](/Indicators/Indicator-LinRegChannel)
...
- [LinRegChannel](/Indicators/Indicator-LinRegChannel) — population-stddev variant.
- [LinearRegression](/Indicators/Indicator-LinearRegression) — the bare endpoint.
- [BollingerBands](/Indicators/Indicator-BollingerBands) — sigma about the mean
  (not the trend).
