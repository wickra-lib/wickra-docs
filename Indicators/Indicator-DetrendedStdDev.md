...
[StandardError](/Indicators/Indicator-StandardError) using a different
denominator. See
...
- [StandardError](/Indicators/Indicator-StandardError) — close cousin (uses
  `n - 2` denominator).
- [StdDev](/Indicators/Indicator-StdDev) — non-detrended baseline.
- [Variance](/Indicators/Indicator-Variance) — squared cousin.
- [LinearRegression](/Indicators/Indicator-LinearRegression) — the fit being
  used.
