...
- [Rsi](Indicator-Rsi) — the underlying building block.
- [LaguerreRsi](Indicator-LaguerreRsi) — Ehlers' alternative
  smoothing-based RSI variant.
- [StochRsi](Indicator-StochRsi) — another RSI composite that
