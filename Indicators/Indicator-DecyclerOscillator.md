...
> Difference between a fast and a slow [Decycler](/Indicators/Indicator-Decycler).
...
- [Decycler](/Indicators/Indicator-Decycler) — the building block.
- [RoofingFilter](/Indicators/Indicator-RoofingFilter) — alternative cycle-band
  extractor.
- [MacdIndicator](/Indicators/Indicator-MacdIndicator) — EMA-based cousin.
