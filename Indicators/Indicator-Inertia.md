...
> smoothing of the [RVI](/Indicators/Indicator-Rvi) series. Preserves trend direction
...
Each bar's [RVI](/Indicators/Indicator-Rvi) value feeds a rolling least-squares
...
1. **Trend persistence.** Positive Inertia ⇒ vigor is trending up ⇒ the
   ...
   raw RVI cross.
2. **Pair with RVI.** Use raw [RVI](/Indicators/Indicator-Rvi) for early reads and
...
- [Rvi](/Indicators/Indicator-Rvi) — the underlying vigor ratio.
