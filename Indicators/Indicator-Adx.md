...
- [Indicator: Rsi](/Indicators/Indicator-Rsi) — shares Wilder smoothing.
- [Indicator: Aroon](/Indicators/Indicator-Aroon) — alternative trend-strength
  measure, range-based.
- [Indicator: MacdIndicator](/Indicators/Indicator-MacdIndicator) — trend-following
