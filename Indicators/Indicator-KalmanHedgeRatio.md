...
trade fades — the Kalman analogue of the [Cointegration](/Indicators/Indicator-Cointegration)
...
[BetaNeutralSpread](/Indicators/Indicator-BetaNeutralSpread) (a fixed-window OLS hedge) and
[Cointegration](/Indicators/Indicator-Cointegration) (a static hedge plus a stationarity
test).
...
- [Indicator-BetaNeutralSpread](/Indicators/Indicator-BetaNeutralSpread) — fixed-window OLS hedge residual.
- [Indicator-Cointegration](/Indicators/Indicator-Cointegration) — static hedge ratio + ADF test.
