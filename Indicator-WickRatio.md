...
Where [BodySizePct](Indicator-BodySizePct) measures how much of the range is
...
- **Not a pattern detector.** This is a continuous geometry feature, not a
  ...
  pattern indicators (e.g. [Indicator-Hammer](Indicator-Hammer)).
...
- [Indicator-BodySizePct](Indicator-BodySizePct) — body fill.
- [Indicator-Hammer](Indicator-Hammer) — a dedicated lower-shadow pattern.
