...
- [OpeningMarubozu](/Indicators/Indicator-OpeningMarubozu) — the marubozu the second bar
  forms.
- [GapSideBySideWhite](/Indicators/Indicator-GapSideBySideWhite) — gap-based continuation.
