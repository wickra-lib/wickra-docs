...
- [SessionRange](Indicator-SessionRange) — Asia/EU/US sub-session ranges.
- [OpeningRange](Indicator-OpeningRange) — first-N-bars range, manual reset.
- [InitialBalance](Indicator-InitialBalance) — locked opening balance.
