...
The project ships 507 indicators across twenty-four families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.7.3   |
| crates.io | `wickra-core`  | 0.7.3   |
| crates.io | `wickra-data`  | 0.7.3   |
| PyPI      | `wickra`       | 0.7.3   |
| npm       | `wickra`       | 0.7.3   |
| npm       | `wickra-wasm`  | 0.7.3   |
