...
- [TreynorRatio](Indicator-TreynorRatio) — Beta-relative cousin.
- [InformationRatio](Indicator-InformationRatio) — tracking-error
  cousin.
- [Beta](Indicator-Beta) — CAPM's other half.
- [SharpeRatio](Indicator-SharpeRatio) — non-CAPM alternative.
