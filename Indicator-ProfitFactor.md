...
- [GainLossRatio](Indicator-GainLossRatio) — average-based cousin.
- [OmegaRatio](Indicator-OmegaRatio) — threshold-aware
  generalisation.
- [KellyCriterion](Indicator-KellyCriterion) — uses PF inputs
  for sizing.
