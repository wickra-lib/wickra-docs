...
chasing noise. Wickra reuses the existing [Cmo](/Indicators/Indicator-Cmo) indicator
...
`warmup_period()` returns `cmo_period + 1`: the inner [Cmo](/Indicators/Indicator-Cmo)
...
- [Cmo](/Indicators/Indicator-Cmo) — the momentum oscillator that gates the smoothing.
- [Ema](/Indicators/Indicator-Ema) — VIDYA's behaviour at full momentum.
- [Kama](/Indicators/Indicator-Kama) — Kaufman's efficiency-ratio-gated adaptive MA, a
  close cousin.
- [Frama](/Indicators/Indicator-Frama) — fractal-dimension-gated adaptive MA.
