...
and regimes, unlike the unbounded [CumulativeVolumeDelta](/Indicators/Indicator-CumulativeVolumeDelta).
...
- [SignedVolume](/Indicators/Indicator-SignedVolume) — the per-trade flow this normalises.
- [CumulativeVolumeDelta](/Indicators/Indicator-CumulativeVolumeDelta) — the unbounded,
  cumulative view of the same flow.
- [Footprint](/Indicators/Indicator-Footprint) — flow imbalance resolved by price level.
