...
Bullish-only (never `−1.0`). A close-cousin of [RisingThreeMethods](Indicator-RisingThreeMethods)
...
- [RisingThreeMethods](Indicator-RisingThreeMethods) — the non-gap sibling.
