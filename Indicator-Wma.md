...
- [Indicator-Sma](Indicator-Sma) — equal weights instead of linear.
- [Indicator-Ema](Indicator-Ema) — exponential decay instead of linear.
- [Indicator-Hma](Indicator-Hma) — Hull MA, built from three WMAs.
