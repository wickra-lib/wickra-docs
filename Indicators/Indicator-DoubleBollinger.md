...
ordered. Internally the indicator runs one [`BollingerBands`](/Indicators/Indicator-BollingerBands)
...
`warmup_period()` delegates to the inner [`BollingerBands`](/Indicators/Indicator-BollingerBands),
...
- **Inner-band identity.** The inner band equals running a separate
  [`BollingerBands`](/Indicators/Indicator-BollingerBands) at `k_inner` (test
...
- [BollingerBands](/Indicators/Indicator-BollingerBands) — single-envelope sibling.
- [BollingerBandwidth](/Indicators/Indicator-BollingerBandwidth) — squeeze detection.
- [PercentB](/Indicators/Indicator-PercentB) — normalised position within a single
  Bollinger envelope.
