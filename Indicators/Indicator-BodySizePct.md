...
The unsigned magnitude companion to [BalanceOfPower](/Indicators/Indicator-BalanceOfPower):
...
with [WickRatio](/Indicators/Indicator-WickRatio) (which side the wicks fall on) for a full
geometric description of a bar.

## Common pitfalls

- **Unsigned.** This drops direction. Use [CloseVsOpen](/Indicators/Indicator-CloseVsOpen)
  or [BalanceOfPower](/Indicators/Indicator-BalanceOfPower) when you need the sign.
...
- [Indicator-BalanceOfPower](/Indicators/Indicator-BalanceOfPower) — the signed version.
- [Indicator-WickRatio](/Indicators/Indicator-WickRatio) — shadow imbalance.
