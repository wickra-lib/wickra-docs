...
> [AverageDrawdown](/Indicators/Indicator-AverageDrawdown); exists as a
...
Same construction as [AverageDrawdown](/Indicators/Indicator-AverageDrawdown).
Becker introduced "Pain Index" as a complementary metric to
[UlcerIndex](/Indicators/Indicator-UlcerIndex) — the Ulcer Index squares
...
Same as [AverageDrawdown](/Indicators/Indicator-AverageDrawdown).
...
- [AverageDrawdown](/Indicators/Indicator-AverageDrawdown) — same metric,
  alternate name.
- [UlcerIndex](/Indicators/Indicator-UlcerIndex) — RMS-weighted alternative.
- [MaxDrawdown](/Indicators/Indicator-MaxDrawdown) — worst-case sibling.
