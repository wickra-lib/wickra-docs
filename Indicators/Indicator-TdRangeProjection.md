...
- [DemarkPivots](/Indicators/Indicator-DemarkPivots) — session-pivot cousin
  with similar branching logic.
- [ClassicPivots](/Indicators/Indicator-ClassicPivots) — non-conditional
  pivot.
- [Atr](/Indicators/Indicator-Atr) — alternative next-bar range estimate.
