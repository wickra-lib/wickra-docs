...
Unlike [`MedianPrice`](/Indicators/Indicator-MedianPrice), which averages a single bar's own
...
of [`Donchian`](/Indicators/Indicator-Donchian) channels, exposed as a standalone scalar for
...
behaviour of a [`Donchian`](/Indicators/Indicator-Donchian) channel midline. Use it as a
slow mean-reversion anchor or as the reference a breakout is measured against.

Prefer [`MedianPrice`](/Indicators/Indicator-MedianPrice) when you want each bar's own
`(H + L) / 2`; prefer [`MidPoint`](/Indicators/Indicator-MidPoint) when your input is a
...
- [Indicator-MidPoint](/Indicators/Indicator-MidPoint) — the scalar-input twin.
- [Indicator-MedianPrice](/Indicators/Indicator-MedianPrice) — per-bar `(H + L) / 2`.
- [Indicator-Donchian](/Indicators/Indicator-Donchian) — the channel whose centre line this is.
