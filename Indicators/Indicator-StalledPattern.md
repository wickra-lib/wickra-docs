...
- **Confusing it with Advance Block.** Both are deliberation tops;
  [AdvanceBlock](/Indicators/Indicator-AdvanceBlock) emphasises shrinking bodies with rising
...
- [AdvanceBlock](/Indicators/Indicator-AdvanceBlock) — sibling deliberation top.
- [ThreeSoldiersOrCrows](/Indicators/Indicator-ThreeSoldiersOrCrows) — the healthy
