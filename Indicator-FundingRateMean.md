...
- **Window of one.** Degenerates to the raw [FundingRate](Indicator-FundingRate).
...
[FundingBasis](Indicator-FundingBasis) to separate a genuine carry from a
...
- [FundingRateZScore](Indicator-FundingRateZScore) — the normalised extreme.
