...
2. **Williams system.** Williams pairs fractals with his
   [Alligator](Indicator-Alligator): a fractal breakout *outside* the
...
- **Expecting an every-bar update.** The bands only step when a new fractal
  ...
  rolling extreme use [Donchian](Indicator-Donchian) instead.
...
- [Donchian](Indicator-Donchian) — every-bar rolling high/low (no fractal
  confirmation).
- [WilliamsFractals](Indicator-WilliamsFractals) — the raw fractal markers.
- [Alligator](Indicator-Alligator) — Williams' moving-average triplet,
  often paired with fractals.
- [AwesomeOscillator](Indicator-AwesomeOscillator) — Williams' momentum
  reading.
