...
- [Atr](Indicator-Atr) — the underlying volatility unit.
- [AtrTrailingStop](Indicator-AtrTrailingStop) — bidirectional
  cousin (flips short instead of going flat).
- [VoltyStop](Indicator-VoltyStop) — extreme-anchored ATR variant.
- [SuperTrend](Indicator-SuperTrend) — symmetric `HL2 ± mult·ATR`
  flip-based stop.
