...
- **Expecting Bollinger-like width in a trend.** A strongly trending series
  ...
  narrower than [BollingerBands](/Indicators/Indicator-BollingerBands) on the same data.
...
- [StandardErrorBands](/Indicators/Indicator-StandardErrorBands) — same skeleton but
...
- [LinRegSlope](/Indicators/Indicator-LinRegSlope) — the slope component.
- [BollingerBands](/Indicators/Indicator-BollingerBands) — dispersion about the mean.
