...
> combining four SMA-smoothed [Roc](Indicator-Roc) series with Pring's fixed
...
- [Roc](Indicator-Roc) — the building block KST sums.
- [Coppock](Indicator-Coppock) — another weighted-ROC long-term momentum
  curve.
- [Pmo](Indicator-Pmo) — the DecisionPoint Price Momentum Oscillator, a
