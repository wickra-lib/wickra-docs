...
- [TdSetup](Indicator-TdSetup) — wider momentum-exhaustion
  signal.
- [TdSequential](Indicator-TdSequential) — full Setup +
  Countdown.
- [TdOpen](Indicator-TdOpen) — gap-and-fade reversal sibling.
- [TdPressure](Indicator-TdPressure) — volume-weighted
  pressure oscillator.
