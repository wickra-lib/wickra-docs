...
> The [Kicking](Indicator-Kicking) pattern with the signal taken from the
...
This can disagree with [Kicking](Indicator-Kicking): a black marubozu kicked up
...
- [Kicking](Indicator-Kicking) — signal from the gap direction.
- [Marubozu](Indicator-Marubozu) — the shadowless candle this is built from.
