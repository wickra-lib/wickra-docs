...
[EveningDojiStar](/Indicators/Indicator-EveningDojiStar). The doji variant of the classic
...
- **24/7 markets.** Uses body gaps (not full gaps), so it fires more readily than
  [AbandonedBaby](/Indicators/Indicator-AbandonedBaby) on gapless feeds.
...
- [EveningDojiStar](/Indicators/Indicator-EveningDojiStar) — the bearish mirror.
