...
smoothed RSI crosses it — exactly like a [`SuperTrend`](/Indicators/Indicator-SuperTrend) on
...
- [Indicator-Rsi](/Indicators/Indicator-Rsi) — the oscillator QQE smooths and trails.
- [Indicator-SuperTrend](/Indicators/Indicator-SuperTrend) — the same trailing-stop idea on price.
- [Indicator-Rsx](/Indicators/Indicator-Rsx) — another smoothed-RSI refinement.
