...
- **Non-cointegrated pairs.** The z-score is only tradeable if the spread
  actually mean-reverts — screen with [Cointegration](Indicator-Cointegration)
  first.
...
- [Cointegration](Indicator-Cointegration) — tests whether the spread is
  stationary at all.
- [PairwiseBeta](Indicator-PairwiseBeta) — return-space sensitivity.
- [ZScore](Indicator-ZScore) — single-series standardisation.
