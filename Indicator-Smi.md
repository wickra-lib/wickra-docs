...
- [Stochastic](Indicator-Stochastic) — the raw `%K`/`%D` SMI smooths.
- [StochRsi](Indicator-StochRsi) — stochastic applied to RSI.
- [Tsi](Indicator-Tsi) — Blau's True Strength Index, the same double-EMA idea
  on momentum.
