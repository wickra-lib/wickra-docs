...
- **Reading it as momentum.** It is a detrended price, not a rate of
  change — see [`Roc`](Indicator-Roc) or [`Mom`](Indicator-Mom) for
  momentum.
...
- [Indicator-Sma](Indicator-Sma) — the moving average DPO
  detrends against.
- [Indicator-Roc](Indicator-Roc) — momentum, the indicator DPO is
  often confused with.
