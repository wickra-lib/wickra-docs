...
- [Donchian](/Indicators/Indicator-Donchian) — sibling rolling-window indicator
  that uses min/max rather than SMA.
- [DonchianStop](/Indicators/Indicator-DonchianStop) — sibling trailing-stop on
  the same rolling-window basis.
- [AtrTrailingStop](/Indicators/Indicator-AtrTrailingStop) — ATR-anchored
  alternative.
