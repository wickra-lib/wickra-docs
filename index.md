...
hero:
  ...
  tagline: One Rust core. The same incremental update for live ticks and backtests. Native Rust, Python, Node.js and WASM bindings, plus a C ABI reaching C, C++, C#, Go, Java and R — install-free.
  image:
    src: /wickra-mark.svg
    alt: Wickra
  actions:
...
features:
  ...
  - title: Same code, live and backtest
    details: Every indicator is an incremental state machine. The update call in your live loop is the exact same code path that drives the historical backtest — no drift.
