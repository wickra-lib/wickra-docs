...
The project ships 314 indicators across nineteen families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.4.6   |
| crates.io | `wickra-core`  | 0.4.6   |
| crates.io | `wickra-data`  | 0.4.6   |
| PyPI      | `wickra`       | 0.4.6   |
| npm       | `wickra`       | 0.4.6   |
| npm       | `wickra-wasm`  | 0.4.6   |
