...
- [Indicator: Rsi](/Indicators/Indicator-Rsi) — same `period + 1` warmup, but
  bounded.
- [Indicator: Trix](/Indicators/Indicator-Trix) — also a rate of change, but on
  a triple-smoothed EMA.
- [Indicator: MacdIndicator](/Indicators/Indicator-MacdIndicator) — momentum
