...
> [PainIndex](/Indicators/Indicator-PainIndex)).
...
- Same as [PainIndex](/Indicators/Indicator-PainIndex) — Thomas Becker's pain
  measure.

## See also

- [PainIndex](/Indicators/Indicator-PainIndex) — same metric, alternative name.
- [MaxDrawdown](/Indicators/Indicator-MaxDrawdown) — worst case.
- [UlcerIndex](/Indicators/Indicator-UlcerIndex) — RMS variant.
