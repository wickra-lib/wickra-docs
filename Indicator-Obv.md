...
- [VWAP](Indicator-Vwap) — volume-weighted price benchmark; OBV and
  VWAP are the two canonical volume-aware indicators in the panel.
- [MFI](Indicator-Mfi) — money-flow index, an oscillator blending
  typical price with volume.
- [SMA](Indicator-Sma) / [EMA](Indicator-Ema) — the smoothers
