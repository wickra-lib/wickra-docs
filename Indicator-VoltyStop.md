...
- [AtrTrailingStop](Indicator-AtrTrailingStop) — re-anchors every
  bar instead of riding the extreme.
- [ChandelierExit](Indicator-ChandelierExit) — high/low-anchored
  cousin.
- [SuperTrend](Indicator-SuperTrend) — `(HL2 ± mult·ATR)`-based
  state machine.
