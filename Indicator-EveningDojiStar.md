...
[MorningDojiStar](Indicator-MorningDojiStar). The doji variant of the classic
...
- **24/7 markets.** The gaps are body gaps (not full gaps), so this fires more
  readily than [AbandonedBaby](Indicator-AbandonedBaby) on gapless feeds.
...
- [MorningDojiStar](Indicator-MorningDojiStar) — the bullish mirror.
