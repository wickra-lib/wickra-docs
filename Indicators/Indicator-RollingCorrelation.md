...
Where [PearsonCorrelation](/Indicators/Indicator-PearsonCorrelation) correlates the raw
...
[RollingCovariance](/Indicators/Indicator-RollingCovariance).

## Common pitfalls

- **Returns, not levels.** This is return correlation. If you want correlation
  of price *levels* use [PearsonCorrelation](/Indicators/Indicator-PearsonCorrelation) — the
...
- [Indicator-RollingCovariance](/Indicators/Indicator-RollingCovariance) — the unnormalised return co-movement.
- [Indicator-PearsonCorrelation](/Indicators/Indicator-PearsonCorrelation) — correlation of raw levels.
