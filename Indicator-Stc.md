...
- [MacdIndicator](Indicator-MacdIndicator) — the unsmoothed source signal.
- [Stochastic](Indicator-Stochastic) — the normalisation STC applies twice.
- [StochRsi](Indicator-StochRsi) — another double-normalised oscillator.
