...
- [Sma](Indicator-Sma) — ALMA at low `sigma` / centred offset.
- [Ema](Indicator-Ema) — comparable responsiveness, more overshoot.
- [Wma](Indicator-Wma) — linear (non-Gaussian) weighting.
- [Hma](Indicator-Hma) — another low-lag smoother.
