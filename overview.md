...
The project ships 292 indicators across eighteen families — moving averages,
...
|-----------|----------------|---------|
| crates.io | `wickra`       | 0.4.4   |
| crates.io | `wickra-core`  | 0.4.4   |
| crates.io | `wickra-data`  | 0.4.4   |
| PyPI      | `wickra`       | 0.4.4   |
| npm       | `wickra`       | 0.4.4   |
| npm       | `wickra-wasm`  | 0.4.4   |
