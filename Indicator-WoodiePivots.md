...
- [ClassicPivots](Indicator-ClassicPivots) — non-weighted variant.
- [FibonacciPivots](Indicator-FibonacciPivots) — Fib-spaced
  alternative.
- [Camarilla](Indicator-Camarilla) — close-anchored four-tier
  alternative.
- [DemarkPivots](Indicator-DemarkPivots) — conditional open-aware
  variant.
