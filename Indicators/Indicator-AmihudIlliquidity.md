...
([RollMeasure](/Indicators/Indicator-RollMeasure), [QuotedSpread](/Indicators/Indicator-QuotedSpread)) and
flow toxicity ([Vpin](/Indicators/Indicator-Vpin)).
...
- [Indicator-RollMeasure](/Indicators/Indicator-RollMeasure) — spread from price-change covariance.
- [Indicator-Vpin](/Indicators/Indicator-Vpin) — flow toxicity.
