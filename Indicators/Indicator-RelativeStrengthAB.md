...
Composes the existing [SMA](/Indicators/Indicator-Sma) and [RSI](/Indicators/Indicator-Rsi) over the
...
- [Rsi](/Indicators/Indicator-Rsi) — single-series momentum oscillator.
- [PairSpreadZScore](/Indicators/Indicator-PairSpreadZScore) — standardised log-spread
  of a pair.
