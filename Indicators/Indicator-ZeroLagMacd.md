...
- [MacdIndicator](/Indicators/Indicator-MacdIndicator) — the EMA-based original
  this indicator de-lags.
- [Zlema](/Indicators/Indicator-Zlema) — the building block; understanding its
  warmup is key to understanding ZeroLagMACD's warmup.
- [Stc](/Indicators/Indicator-Stc) — Schaff Trend Cycle, another faster-than-MACD
