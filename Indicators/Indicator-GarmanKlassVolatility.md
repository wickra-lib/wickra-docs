...
- **Drift bias.** Unbiased only under driftless GBM. For data with
  ...
  [YangZhangVolatility](/Indicators/Indicator-YangZhangVolatility) instead.
...
2. **When to prefer it.** Best on near-continuous intraday data with little
   ...
   [RogersSatchellVolatility](/Indicators/Indicator-RogersSatchellVolatility) (drift) or
   [YangZhangVolatility](/Indicators/Indicator-YangZhangVolatility) (gaps) instead.
