...
the change in raw price units. [`Roc`](/Indicators/Indicator-Roc) is the same idea
...
different price levels; use [`Roc`](/Indicators/Indicator-Roc) when you need a
...
- [Indicator-Roc](/Indicators/Indicator-Roc) — the percentage-scaled counterpart.
- [Indicator-Cmo](/Indicators/Indicator-Cmo) — bounded momentum from summed changes.
