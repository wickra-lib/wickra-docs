...
In practice the GMA plots just below an [`Sma`](Indicator-Sma) of the same
...
- [Indicator-Sma](Indicator-Sma) — the arithmetic counterpart; GMA ≤ SMA always.
- [Indicator-LogReturn](Indicator-LogReturn) — log-space transform the GMA is built on.
