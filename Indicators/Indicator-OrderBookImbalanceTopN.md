...
- **Versus Top-1 and Full.** Summing several levels is more robust to
  single-level spoofing than [Top-1](/Indicators/Indicator-OrderBookImbalanceTop1) while
  staying more responsive than the whole
  [Full](/Indicators/Indicator-OrderBookImbalanceFull) book. The `levels` knob trades
...
- **Dilution at large `levels`.** Summing deep, rarely-hit liquidity drowns the
  ...
  [Full](/Indicators/Indicator-OrderBookImbalanceFull) measure.
...
- [OrderBookImbalanceTop1](/Indicators/Indicator-OrderBookImbalanceTop1) — the most
  responsive, single-level version.
- [OrderBookImbalanceFull](/Indicators/Indicator-OrderBookImbalanceFull) — the whole-book,
  slowest version.
- [DepthSlope](/Indicators/Indicator-DepthSlope) — the shape, not just the imbalance, of
  depth.
