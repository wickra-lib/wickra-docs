...
[TrueRange](Indicator-TrueRange), a volatility scale — so PGO normalises the
...
- [Atr](Indicator-Atr) / [TrueRange](Indicator-TrueRange) — the volatility
  scale in the denominator.
- [Cci](Indicator-Cci) — another mean-displacement-over-dispersion
  oscillator (uses mean absolute deviation instead of ATR).
- [ZScore](Indicator-ZScore) — displacement normalised by standard
