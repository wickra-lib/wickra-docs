...
- [Autocorrelation](/Indicators/Indicator-Autocorrelation) — single-lag
  cousin.
- [DetrendedStdDev](/Indicators/Indicator-DetrendedStdDev) — regression-
  residual volatility.
- [Variance](/Indicators/Indicator-Variance) — short-horizon dispersion.
