...
a strict subset of [DragonflyDoji](Indicator-DragonflyDoji). Thresholds are
...
2. **Stronger than a dragonfly.** Because Takuri demands a longer lower shadow
   ...
   [DragonflyDoji](Indicator-DragonflyDoji) signal.
...
- [DragonflyDoji](Indicator-DragonflyDoji) — the looser parent pattern.
- [Hammer](Indicator-Hammer) — small body at the top with a long lower shadow.
