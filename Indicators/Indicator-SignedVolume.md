...
[CumulativeVolumeDelta](/Indicators/Indicator-CumulativeVolumeDelta); windowing and
normalising it gives [TradeImbalance](/Indicators/Indicator-TradeImbalance); bucketing it by
price gives the [Footprint](/Indicators/Indicator-Footprint).
...
- [CumulativeVolumeDelta](/Indicators/Indicator-CumulativeVolumeDelta) — the running sum of
  signed volume.
- [TradeImbalance](/Indicators/Indicator-TradeImbalance) — its bounded, windowed
  normalisation.
- [Footprint](/Indicators/Indicator-Footprint) — signed volume resolved by price level.
