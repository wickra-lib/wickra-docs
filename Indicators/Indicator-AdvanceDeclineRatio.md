...
- [Indicator-AdvanceDecline](/Indicators/Indicator-AdvanceDecline) — the cumulative A/D Line.
- [Indicator-BreadthThrust](/Indicators/Indicator-BreadthThrust) — smoothed advancing share.
