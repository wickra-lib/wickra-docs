...
- **Standard Error Bands.** Stack `±2 · StandardError` around the
  ...
  bands — see [StandardErrorBands](Indicator-StandardErrorBands).
...
- [StandardErrorBands](Indicator-StandardErrorBands) — band
  visualisation.
- [LinearRegression](Indicator-LinearRegression) — the line itself.
- [LinRegSlope](Indicator-LinRegSlope) — slope alone.
- [RSquared](Indicator-RSquared) — explained-variance ratio.
