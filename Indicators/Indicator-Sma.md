...
- [Indicator-Ema](/Indicators/Indicator-Ema) — same smoothness budget, less lag.
- [Indicator-Wma](/Indicators/Indicator-Wma) — linear weights instead of equal.
- [Indicator-Hma](/Indicators/Indicator-Hma) — built on three WMAs for near-zero
  lag.
