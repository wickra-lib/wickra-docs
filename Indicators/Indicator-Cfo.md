...
[LinearRegression](/Indicators/Indicator-LinearRegression) of the same period, which
...
- **Confusing CFO with the forecast itself.** CFO is the *deviation* from
  the [LinearRegression](/Indicators/Indicator-LinearRegression) endpoint, not the
...
- [LinearRegression](/Indicators/Indicator-LinearRegression) — the forecast CFO
  deviates from.
- [LinRegSlope](/Indicators/Indicator-LinRegSlope) — the trend slope.
- [Cmo](/Indicators/Indicator-Cmo) — Chande's momentum oscillator companion.
