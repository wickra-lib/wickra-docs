...
an economic mechanism. Combine with [Cointegration](/Indicators/Indicator-Cointegration) to
...
- [Indicator-Cointegration](/Indicators/Indicator-Cointegration) — long-run equilibrium between the legs.
- [Indicator-RollingCorrelation](/Indicators/Indicator-RollingCorrelation) — contemporaneous co-movement.
