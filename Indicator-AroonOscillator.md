...
where [`Aroon`](Indicator-Aroon) reports two `[0, 100]` lines measuring
...
- [Indicator-Aroon](Indicator-Aroon) — the two-line indicator this
  collapses.
- [Indicator-Adx](Indicator-Adx) — another trend-strength gauge.
