...
[KickingByLength](Indicator-KickingByLength). See
...
- **Length disagreement.** When the two marubozu differ in size,
  [KickingByLength](Indicator-KickingByLength) can report the opposite sign.
...
- [KickingByLength](Indicator-KickingByLength) — signal from the longer marubozu.
