...
inputs. Where [`MidPrice`](/Indicators/Indicator-MidPrice) takes its extremes from a candle's
...
It is the scalar twin of [`MidPrice`](/Indicators/Indicator-MidPrice) (which reads candle
high/low) and is numerically the centre line of a [`Donchian`](/Indicators/Indicator-Donchian)
...
- [Indicator-MidPrice](/Indicators/Indicator-MidPrice) — the candle-input twin over high/low.
