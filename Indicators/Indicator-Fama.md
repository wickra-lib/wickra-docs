...
> [Mama](/Indicators/Indicator-Mama). FAMA is MAMA's lagging companion in
...
- **Confirmation, not signal.** Trend confirmation systems use the
  *crossing* of MAMA over FAMA — but for that you want the paired
  `MamaOutput` from [Mama](/Indicators/Indicator-Mama) directly, not this
  wrapper.
...
- [Mama](/Indicators/Indicator-Mama) — the parent indicator that emits both
  lines together.
