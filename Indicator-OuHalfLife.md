...
[SpreadAr1Coefficient](Indicator-SpreadAr1Coefficient): the half-life is
`−ln(2) / ln(ρ)` for `0 < ρ < 1`.
...
Pair it with [SpreadAr1Coefficient](Indicator-SpreadAr1Coefficient) (reversion
strength) and [PairSpreadZScore](Indicator-PairSpreadZScore) (entry timing).
...
- [Indicator-SpreadAr1Coefficient](Indicator-SpreadAr1Coefficient) — AR(1) reversion strength.
