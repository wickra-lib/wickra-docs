...
Unlike [BalanceOfPower](/Indicators/Indicator-BalanceOfPower) — which normalises the body by
...
[BalanceOfPower](/Indicators/Indicator-BalanceOfPower); for the unsigned magnitude use
[BodySizePct](/Indicators/Indicator-BodySizePct).
...
- [Indicator-BalanceOfPower](/Indicators/Indicator-BalanceOfPower) — body normalised by range.
- [Indicator-BodySizePct](/Indicators/Indicator-BodySizePct) — unsigned body magnitude.
