...
| `macd_fast`   | `usize` | `12`    | `>= 1`, `< macd_slow` | inner [MacdIndicator](Indicator-MacdIndicator) |
...
- [MacdIndicator](Indicator-MacdIndicator) — the momentum branch.
- [Ema](Indicator-Ema) — the trend branch.
- [Apo](Indicator-Apo) — the raw MACD line without the histogram slope.
