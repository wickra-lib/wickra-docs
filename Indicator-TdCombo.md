...
Setup phase is identical to [TdSetup](Indicator-TdSetup) (arms the
...
- [TdSequential](Indicator-TdSequential) — vanilla Setup +
  Countdown.
- [TdCountdown](Indicator-TdCountdown) — standalone vanilla
  countdown.
- [TdSetup](Indicator-TdSetup) — setup phase.
