...
- [EMA](/Indicators/Indicator-Ema) — the centerline component.
- [ATR](/Indicators/Indicator-Atr) — the envelope width component.
- [Bollinger Bands](/Indicators/Indicator-BollingerBands) — envelope using stddev
  rather than ATR; useful side-by-side comparison.
- [Donchian Channels](/Indicators/Indicator-Donchian) — envelope using rolling
