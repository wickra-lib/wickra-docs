...
- **Versus the effective spread.** The quoted spread is what the book
  *advertises*; the [EffectiveSpread](/Indicators/Indicator-EffectiveSpread) is what trades
...
- **It ignores size.** A tight quote for one lot can still be expensive to
  ...
  [DepthSlope](/Indicators/Indicator-DepthSlope) or
  [OrderBookImbalanceTopN](/Indicators/Indicator-OrderBookImbalanceTopN) to see depth.
...
- [EffectiveSpread](/Indicators/Indicator-EffectiveSpread) — what trades actually paid
  versus the quote.
- [RealizedSpread](/Indicators/Indicator-RealizedSpread) — the spread the maker keeps after
  price impact.
- [Microprice](/Indicators/Indicator-Microprice) — fair value inside the spread.
