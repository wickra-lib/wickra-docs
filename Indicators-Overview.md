...
Wickra ships **485 indicators** organised into **twenty-four families**. Each
...
| `WilliamsAd` | Larry Williams' Accumulation/Distribution — a cumulative, **volume-free** line that adds true-low accumulation on up-closes and true-high distribution on down-closes. | `Candle` | `f64` | `(−∞, +∞)` (a cumulative line; only slope/divergence matters) | (no parameters) | `2` | [Indicator-WilliamsAd](/Indicators/Indicator-WilliamsAd) |
