...
Same as [HilbertDominantCycle](/Indicators/Indicator-HilbertDominantCycle):
...
- [Mama](/Indicators/Indicator-Mama) — built on the same phase machinery.
- [SineWave](/Indicators/Indicator-SineWave) — visualises the phase that
