...
- **Head dominance.** If all three highs are equal the detector returns `0.0` and
  defers to [TripleTopBottom](Indicator-TripleTopBottom) — H&S requires a head
...
- [DoubleTopBottom](Indicator-DoubleTopBottom), [TripleTopBottom](Indicator-TripleTopBottom).
