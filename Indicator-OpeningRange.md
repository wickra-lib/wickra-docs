...
> to [InitialBalance](Indicator-InitialBalance) but with a shorter
...
- [InitialBalance](Indicator-InitialBalance) — longer cousin
  without breakout-distance.
- [ValueArea](Indicator-ValueArea) — session-volume distribution.
- [Donchian](Indicator-Donchian) — continuous rolling channel.
