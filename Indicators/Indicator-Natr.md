...
[`Atr`](/Indicators/Indicator-Atr) measures volatility in raw price units — a `2.0`
...
[`Atr`](/Indicators/Indicator-Atr) only when you specifically want the answer in
...
- [Indicator-Atr](/Indicators/Indicator-Atr) — the price-unit original.
- [Indicator-HistoricalVolatility](/Indicators/Indicator-HistoricalVolatility) —
