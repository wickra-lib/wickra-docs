...
```rust
use wickra::{Indicator, Trima};
// Trima: Input = f64, Output = f64
const _: fn(&mut Trima, f64) -> Option<f64> = <Trima as Indicator>::update;
```
...
[`Ema`](/Indicators/Indicator-Ema) or [`Hma`](/Indicators/Indicator-Hma) when responsiveness
matters.
...
- [Indicator-Sma](/Indicators/Indicator-Sma) — the building block applied twice.
- [Indicator-Wma](/Indicators/Indicator-Wma) — linear (not triangular) weights.
- [Indicator-Smma](/Indicators/Indicator-Smma) — the other F1 average.
