...
- [Bollinger Bands](/Indicators/Indicator-BollingerBands) — envelope shaped by
  stddev rather than rolling extrema.
- [Keltner Channels](/Indicators/Indicator-Keltner) — envelope shaped by ATR
  around an EMA centerline.
- [PSAR](/Indicators/Indicator-Psar) — alternative trailing-stop construction
