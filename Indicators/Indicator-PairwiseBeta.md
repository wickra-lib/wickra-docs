...
> [Beta](/Indicators/Indicator-Beta), which regresses the raw inputs it is fed,
...
- **Levels vs returns.** Use [Beta](/Indicators/Indicator-Beta) if you have already
...
- [Beta](/Indicators/Indicator-Beta) — same OLS slope on the raw inputs you feed it.
- [PairSpreadZScore](/Indicators/Indicator-PairSpreadZScore) — the spread between two
  cointegrated legs.
- [PearsonCorrelation](/Indicators/Indicator-PearsonCorrelation) — unit-free cousin.
