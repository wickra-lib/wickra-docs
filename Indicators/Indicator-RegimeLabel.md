...
[JumpIndicator](/Indicators/Indicator-JumpIndicator) (discrete shocks) and
[RealizedVolatility](/Indicators/Indicator-RealizedVolatility) (continuous level).
...
- [Indicator-JumpIndicator](/Indicators/Indicator-JumpIndicator) — discrete return shocks.
- [Indicator-RealizedVolatility](/Indicators/Indicator-RealizedVolatility) — the volatility graded here.
- [Indicator-RollingQuantile](/Indicators/Indicator-RollingQuantile) — the quantile primitive used.
