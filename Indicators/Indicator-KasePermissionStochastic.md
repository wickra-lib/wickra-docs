...
- [Indicator-Stochastic](/Indicators/Indicator-Stochastic) — the raw `%K`/`%D` this smooths twice.
- [Indicator-Ema](/Indicators/Indicator-Ema) — the smoothing applied to the fast and slow lines.
