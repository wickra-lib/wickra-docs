...
- [RoofingFilter](Indicator-RoofingFilter) — SuperSmoother +
  high-pass = cycle-band bandpass.
- [Decycler](Indicator-Decycler) — complementary trend extractor.
- [Zlema](Indicator-Zlema) — alternative low-lag smoother (not
  critically damped).
