...
close. Unlike [Vwma](/Indicators/Indicator-Vwma) (a per-bar weighted *mean*), EVWMA's
...
- **Comparing it to [Vwma](/Indicators/Indicator-Vwma) one-for-one.** VWMA is a windowed
...
- [Vwma](/Indicators/Indicator-Vwma) — windowed volume-weighted mean.
- [Vwap](/Indicators/Indicator-Vwap) — cumulative volume-weighted average price.
- [Sma](/Indicators/Indicator-Sma) / [Ema](/Indicators/Indicator-Ema) — volume-agnostic baselines.
